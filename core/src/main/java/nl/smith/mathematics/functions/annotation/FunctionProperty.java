...
/**
 * Annotation to be used on instance properties who are initialized during instantiation of the enclosing class of type {@link AbstractFunction}.<br>
 * The property should be non final and preferably private without a setter method.<br>
 * If the class has one or more properties annotated with {@link FunctionProperty} with {@link FunctionProperty#nullable()} set to false, the class should have an associated property file.<br>
