...
/** This annotation is used in marking a {@link NumberOperations} arguments as being a positive number */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.PARAMETER)
@ArgumentConstraint
public @interface AssertIsPositive {
	String errorFormat() default "The assertion that the number {} is a positive number is not correct";
	...
	String validationMethod() default "assertIsPositive";
}
